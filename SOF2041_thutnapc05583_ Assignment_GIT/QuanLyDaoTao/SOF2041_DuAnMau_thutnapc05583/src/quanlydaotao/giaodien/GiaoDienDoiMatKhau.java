 ...
 * @author Anh Thu
 */
public class GiaoDienDoiMatKhau extends javax.swing.JDialog {

    NhanVienDAO dao = new NhanVienDAO();

    public GiaoDienDoiMatKhau(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        btnDongY.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quanlydaotao/img/Tick.png"))); // NOI18N
        ...
        btnHuyBo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quanlydaotao/img/close.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtMatKhau1, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(24, 24, 24)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaoDienDoiMatKhau dialog = new GiaoDienDoiMatKhau(new javax.swing.JFrame(), true);
    ...
    private void doiMatKhau() {
        ...
        if (!maNV.equalsIgnoreCase(Auth.user.getMaNV())) {
            MsgBox.alert(this, "Sai tên đăng nhập, vui lòng nhập lại.");
        } else if (!matKhau.equalsIgnoreCase(Auth.user.getMatKhau())) {
            MsgBox.alert(this, "Sai mật khẩu đăng nhập, vui lòng nhập lại.");
        } else if (!matKhauMoi.equals(matKhauMoi2)) {
            MsgBox.alert(this, "Xác nhận đăng nhập không đúng, vui lòng nhập lại.");
        } else {
