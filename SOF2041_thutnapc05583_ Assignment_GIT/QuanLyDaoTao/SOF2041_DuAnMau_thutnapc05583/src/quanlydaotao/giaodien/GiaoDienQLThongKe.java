 ...
 * @author Anh Thu
 */
public class GiaoDienQLThongKe extends javax.swing.JFrame {

    ThongKeDAO dao = new ThongKeDAO();
    KhoaHocDAO khdao = new KhoaHocDAO();

    public GiaoDienQLThongKe() {
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaoDienQLThongKe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GiaoDienQLThongKe().setVisible(true);
            }
        });
    }
